...
tags:
  - WTFunding
---
![stylized pic of a double helix](/img/bioinformatics-02.jpg)
...
![Mr. DNA from Jurassic Park gif](/img/bioinformatics-01.gif)*The [reference](https://www.youtube.com/watch?v=qUaFYzFFbBU), for those who have had the misfortune of never watching “Jurassic Park.”*
...
![Reference pic about chromosomes, DNA, nucleosome, etc.](/img/bioinformatics-03.png)
...
![Pic of DNA encoding](/img/bioinformatics-04.png)
...
![DNA purification](/img/bioinformatics-05.jpg)
...
![Diagram of a DNA molecule broken apart by its ribbons / strands, by Kelly Shortridge](/img/dna-molecule.png)
...
#### Sequence Reaction
![DNA sequencing gif](/img/bioinformatics-06.gif)*Note: this is a sequencing UI from a TV show and thus should be disregarded entirely as resembling reality*
...
![Visualizing the de Bruijn graph and overlap-layout-consensus algorithms, by Kelly Shortridge](/img/overlap-consensus-de-bruijn-graph.png)
...
![Raptor with DNA overlayed](/img/velociraptor-dna.jpg)*An example of a DNA sequence and foreshadowing of my “what are the risks” section*
...
![An illustration of a substitution matrix for DNA sequence analysis, by Kelly Shortridge](/img/substitution-matrix-dna.png)
...
![An illustration of GHOSTX and suffix arrays for DNA sequence analysis, by Kelly Shortridge](/img/suffix-array-dna.png)
...
![Cold storage of dino DNA](/img/cold-storage-dino-dna.jpg)*This is not the sort of DNA data storage I mean.*
...
![Ian Malcolm gif saying "Well, there it is"](/img/ian-malcolm-there-it-is.gif)*The O.G. thought leader.*
...
### Pharmaceuticals
![Pharmaceutical person doing something](/img/bioinformatics-07.JPG)
...
![Doctor with an adorable puppy](/img/bioinformatics-08.jpg)*In 2030, scientists will discover the key to all health issues is giving someone a puppy.*
...
### Genetic Testing
![Newborn baby's foot](/img/bioinformatics-09.jpg)
...
![Gif of how Crispr works](/img/crispr.gif)
...
![A faceless person in a latex suit with DNA printed on them](/img/bioinformatics-12.jpg)*In the future, apparently we’ll be featureless and wear latex suits with our genomes printed on them.*
...
![Image of pills over twenty dollar bills](/img/bioinformatics-11.jpg)*Pillz on ya billz*
...
![Ian Malcolm saying "yeah, yeah, but your scientists were so preoccupied with whether or not they could that they didn't stop to think if they should"](/img/ian-malcolm-warning.gif)*And we all know how well Jurassic Park turned out*
...
![Snake with needles for fangs, it's pretty weird](/img/bioinformatics-10.jpg)*Implanting needles in snakes’ mouths as fangs is clearly the most efficient bioweapon distribution mechanism…*
...
![Ian Malcolm saying "Life finds a way"](/img/life-finds-a-way.gif)*Bioinformatics startups will find a way*
