...
![Gif of Cher from Clueless thinking](/img/thinking-clueless.gif)*Get your thinky thinky face on*
...
![An example of belief prompting for information security, by Kelly Shortridge](/img/belief-prompting-example.png)

***

## <a name="decision-trees"></a>Decision Trees
![Jared from the show Silicon Valley presenting a SWOT analysis](/img/jared-swot.gif)*I’m basically Jared for the infosec industry*
...
![An example of a decision tree for information security, by Kelly Shortridge](/img/decision-tree-example.png)
...
## Social Tactics
![A gif of kittens having a "meeting"](/img/kittens-meeting.gif)*omg it's kittens having a meeting*
